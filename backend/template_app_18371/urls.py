"""template_app_18371 URL Configuration
...
admin.site.site_header = "Template APP"
admin.site.site_title = "Template APP Admin Portal"
admin.site.index_title = "Template APP Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version="v1",
        description="API documentation for Template APP App",
    ),
    public=True,
